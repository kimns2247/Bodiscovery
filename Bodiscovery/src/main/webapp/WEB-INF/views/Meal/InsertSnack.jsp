...
<br>
	...
	<form class="container" action="meal4Complete" method="post" onsubmit="return CheckForm()">
	<table align="center">
	...
	<tr>
  	...
  	<div class="center">
	  <button type="submit" class="btn btn-outline-dark mt-auto">간식 등록하기</button> <br>
	</div>
